...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/arthur/.local/share/nvim/site/pack/packer/start/copilot.vim",
    url = "https://github.com/github/copilot.vim"
  },
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/home/arthur/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["vim-matchup"] = {
    after_files = { "/home/arthur/.local/share/nvim/site/pack/packer/opt/vim-matchup/after/plugin/matchit.vim" },
    loaded = true,
    needs_bufread = true,
    path = "/home/arthur/.local/share/nvim/site/pack/packer/opt/vim-matchup",
